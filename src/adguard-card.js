...
console.log("AdGuard Card is being loaded..."); // Debug log
...
if (!customElements.get("adguard-card")) {
  class AdGuardCard extends LitElement {
    ...
    render() {
      ...
      const switches = {
        ...
        safeBrowsing:
          this.hass.states["switch.adguard_home_veilig_browsen"]?.state ===
          "on",
        safeSearch:
  ...
  window.customElements.define("adguard-card", AdGuardCard);
  console.log("AdGuard Card has been registered!"); // Debug log
}
...
window.customCards.push({
  type: "adguard-card",
  name: "AdGuard Card",
  description: "A custom card for AdGuard Home stats and controls",
});
